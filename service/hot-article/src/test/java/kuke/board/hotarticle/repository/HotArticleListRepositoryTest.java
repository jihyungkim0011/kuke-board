...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        //given
        LocalDateTime time = LocalDateTime.of(2026, 3, 16, 0, 0);
        long limit = 3;
        ...
        //then
        List<Long> articleIds = hotArticleListRepository.readAll("20260316");
        ...
        assertThat(hotArticleListRepository.readAll("20260316")).isEmpty();
    }
